...
| **Context** | Prompts | A clever prompt helps once. A systematic context system helps every time. 44 skills + 34 agents + 199 lib modules exist so the AI receives the right context at the right moment. |
